...
export default function ComonHeader() {
    ...
    return (
        <>
            <div className="w-full py-2 bg-[#D9D9D9] flex items-center justify-between px-4 border-b-2 border-[#4AD0DB] shadow-md sm:px-8">
                <Link to='/dashboard'>
                    <FaArrowLeftLong className='text-2xl text-gray-800' />
                </Link>
                <Link to='/profile'>
